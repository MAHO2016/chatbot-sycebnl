...
Pour cette questions et toutes les questions relatives aux éléments constitutifs des états financiers des projets de développement, il faut préciser ou répondre qu'il n'existe pas le modèle SMT pour les projets de développement.
"Quels sont les éléments constitutifs selon le système minimal de trésorerie des projets de developpement?"
